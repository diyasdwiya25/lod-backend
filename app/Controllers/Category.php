...
class Category extends BaseController
{
    ...
    {
        $this->mdl = new \App\Models\CategoryModel();
    ...
    public function show()
    {
        ...
        $response = [
            ...
            'error'    => null,
            'messages' => [
                'success' => 'Berhasil Menampilkan list category'
            ],
            'data' => $data,
        ];
    ...
    public function find($id)
    {
        ...
        if($data){
            $response = [
                ...
                'error'    => null,
                'messages' => [
                    'success' => 'Berhasil Menampilkan category'
                ],
                'data' => $data,
            ];
        }else{
    ...
    public function create()
    {
		...
		$validate = $this->validation->run($data, 'create_category');
	...
	public function update($id = null)
    {
        ...
        $validate = $this->validation->run($data, 'update_category');
        $errors = $this->validation->getErrors();
